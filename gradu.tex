...
Gherkinin ohella monet BDD-testikehykset käyttävät omia parsereitaan. Esimerkiksi RSpec \cite{rspec} ja Jasmine \cite{jasmine} eivät käytä Gherkiniä, vaan niissä on toteutettu omat parserit testien tulkkaamiseen.
